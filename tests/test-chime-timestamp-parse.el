...
(chime-deftest test-chime-timestamp-parse-standard-timestamp-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-scheduled-timestamp-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-deadline-timestamp-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-timestamp-with-weekly-repeater-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-timestamp-with-completion-repeater-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-timestamp-with-catchup-repeater-returns-time-list ()
  "Test that a timestamp with ++1w repeater parses correctly.
...
(chime-deftest test-chime-timestamp-parse-timestamp-with-time-range-returns-start-time ()
...
(chime-deftest test-chime-timestamp-parse-timestamp-with-date-range-returns-start-date ()
...
(chime-deftest test-chime-timestamp-parse-midnight-timestamp-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-last-minute-of-day-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-year-boundary-new-years-eve-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-year-boundary-new-years-day-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-single-digit-time-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-leap-year-feb-29-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-month-boundary-end-of-month-returns-time-list ()
...
(chime-deftest test-chime-timestamp-parse-tomorrow-timestamp-returns-correct-date ()
  ...
  (with-test-time (encode-time 0 23 11 2 11 2025) ; Nov 02, 2025 11:23:00 AM
                  (let* ((tomorrow-timestamp "<2025-11-03 Mon 10:00-10:30>")
                    ...
                    (let* ((parsed-time (append parsed '(0 0)))
                      ...
                      (should (< time-diff-seconds 81480))))))

;;; Error Cases

(chime-deftest test-chime-timestamp-parse-empty-string-returns-nil ()
  "Test that empty string returns nil."
  (let* ((timestamp "")
         (result (chime--timestamp-parse timestamp)))
    (should (null result))))

(chime-deftest test-chime-timestamp-parse-nil-input-returns-nil ()
  "Test that nil input returns nil."
  (let* ((timestamp nil)
         (result (chime--timestamp-parse timestamp)))
    (should (null result))))

(chime-deftest test-chime-timestamp-parse-missing-opening-bracket-returns-nil ()
  "Test that timestamp missing opening bracket returns nil."
  (let* ((timestamp "2025-10-24 Fri 14:00>")
         (result (chime--timestamp-parse timestamp)))
    (should (null result))))

(chime-deftest test-chime-timestamp-parse-missing-closing-bracket-returns-nil ()
  "Test that timestamp missing closing bracket returns nil."
  (let* ((timestamp "<2025-10-24 Fri 14:00")
         (result (chime--timestamp-parse timestamp)))
    (should (null result))))

(chime-deftest test-chime-timestamp-parse-invalid-date-format-returns-nil ()
  "Test that invalid date format returns nil."
  (let* ((timestamp "<10-24-2025 Fri 14:00>")
         (result (chime--timestamp-parse timestamp)))
    (should (null result))))

(chime-deftest test-chime-timestamp-parse-invalid-month-returns-nil ()
  "Test that invalid month value returns nil."
  (let* ((timestamp "<2025-13-24 Fri 14:00>")
         (result (chime--timestamp-parse timestamp)))
    (should (null result))))

(chime-deftest test-chime-timestamp-parse-invalid-day-returns-nil ()
  "Test that invalid day value returns nil."
  (let* ((timestamp "<2025-10-32 Fri 14:00>")
         (result (chime--timestamp-parse timestamp)))
    (should (null result))))

(chime-deftest test-chime-timestamp-parse-invalid-time-hour-returns-nil ()
  "Test that invalid hour value returns nil."
  (let* ((timestamp "<2025-10-24 Fri 25:00>")
         (result (chime--timestamp-parse timestamp)))
    (should (null result))))

(chime-deftest test-chime-timestamp-parse-invalid-time-minute-returns-nil ()
  "Test that invalid minute value returns nil."
  (let* ((timestamp "<2025-10-24 Fri 14:60>")
         (result (chime--timestamp-parse timestamp)))
    (should (null result))))

(chime-deftest test-chime-timestamp-parse-date-only-no-time-returns-nil ()
