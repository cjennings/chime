...
CHIME (backronym: *CHIME Heralds Imminent Modeline Events*) keeps your org-agenda events from slipping past unnoticed. You get desktop notifications, an audible chime, and your next event shows up in the modeline.
...
- Themeable modeline faces that shift color as the next event gets closer
